<?php
date_default_timezone_set('Asia/Malang');
...
echo "\e[94m  =\e[97m 🤸  3. VOUCHER GOFOOD 30K MINBEL 30K  ✄1�7 🇮🇩 \e[92m=\n";
...
echo "\e[93m▬▬▬▬▬pilih y atau sudah▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
	goto login;
login:
echo "\e[93m▬▬▬▬▬tuliskan bacaan gondrong di bawah ini▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
$pass =  ( '╄1�7 User Login : ' );
echo "\033[30;40m";
...
else
{
		...
		echo "\e[93m[🚫]           \e[91mSEGERA MINTA IZIN          \e[93m [🚫]\n";
	        echo "\e[93m[🚫]             \e[91m@Gondrong Termux       \e[93m [🚫]\n";
		echo "\e[99m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
goto login;
}
	return rtrim( $input, "\n" );
...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD090320B"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("pink","🔓▶️ Message: ".$message);
        echo "\n".color("nevy","🔒▶️ Claim voucher 4");
        echo "\n".color("blue","⏳▶︄1�7 Sabar");
        for($a=1;$a<=3;$a++){
        echo color("blue",".");
        sleep(1);
        ...
        sleep(5);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code"ANTIBOKEKLAH"}');
