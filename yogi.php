...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD2207"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("pink","🔓▶️ Message: ".$message);
        goto gofood;
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PESANGOFOOD2207"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("pink","🔓▶️ Message: ".$message);
        ...
        sleep(5);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"MAKANGOFOOD2207"}');
