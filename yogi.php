...
echo "\e[93m▬▬▬▬▬pilih y atau sudah▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
	goto login;
login:
echo "\e[93m▬▬▬▬▬Ijin dlu ya lain kali ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
$pass =  ( '╄1�7 User Login : ' );
echo "\033[30;40m";
...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGFO"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("pink","🔓▶️ Message: ".$message);
        goto gofood;
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFO6"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("pink","🔓▶️ Message: ".$message);
        ...
        sleep(5);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code"MAKANGOFOOD2206MAKANGOFOOD2206"}');
