...
$token = $accesstoken;
        ...
        echo "\n".color("red"," ▬▬▬▬▬▬▬▬▬▬▬▬CLAIM VOUCHER▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy","🔒▶️ 1. Claim GO-Mart V1 kEDIRI  . . .");
        echo "\n".color("yellow","⏳▶️ Please wait.... Skip");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(8);
        }
        $code1 = request1('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOODBARU"}');
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
          gocar:
        echo "\n".color("nevy","🔒▶️ 2. Claim G-Mart v2 SIDOARJO  . . .");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(8);
        }
        $code1 = request2('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOODBARU"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green","🔓▶️ Message: ".$message);
        goto gofood;
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("nevy","🔒▶️ 3. Claim Go-Mart v3 BNDNG . . .");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(8);
        }
        $code1 = request3('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOJ3KAMAN"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green","🔓▶️ Message: ".$message);
        goto goca;
