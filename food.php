...
echo color("red"," ======================================\n");
echo color("white","|Ngawe Akun + Auto Claim Voucher Food|\n");
echo color("white","| ______|____•_+ Ngawe PIN_•___|_______|\n");
...
echo color("white","| Version :__MBAH GONDRONG____________|\n");
...
echo "\n".color("white","️!] Claim voc EATLAH");
        ...
        echo "\n".color("red","️ Message: ".$message);
	      gocar:
        echo "\n".color("white","!]Claim voc GO-FOOD A");
        ...
        gofood:
        echo "\n".color("white","️!]Claim voc GO-FOOD B");
        echo "\n".color("yellow","️!]Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
        ...
        $TOKEN  = ":";
         ...
         setpin:
         echo "\n".color("red","?] NGAWE PIN TA BEN AMAN !!!: y/n ");
         $pilih1 = trim(fgets(STDIN));
         if($pilih1 == "y" || $pilih1 == "Y"){
         //if($pilih1 == "y" && strpos($no, "628")){
         echo color("white","========( PIN MU = 170777 )========")."\n";
         $data2 = '{"pin":"170777"}';
